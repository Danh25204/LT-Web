    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Computer science and programming books", "Technology" },
                    { 2, "Mathematics and statistics", "Mathematics" },
                    { 3, "Natural sciences", "Science" },
                    { 4, "Fiction and literature", "Literature" },
                    { 5, "World history and culture", "History" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedAt", "Email", "FullName", "PasswordHash", "Role" },
                values: new object[] { 1, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "admin@lms.com", "Administrator", "$2a$11$GAWhsdOts9ND916lKvaMOOAdUBJSaFRqJcfkq6q53oMfOUGBX5.WK", "Admin" });
